        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">เลือกร้านอาหาร เพื่อดูรายการราคาอาหาร</h4>
                    
                </div>
                <div class="card-body">
                    <p class="demo">
                        @foreach ($stores as $store => $value)
                            <a href="{{url('/admin/list-menu-price')}}/{{$value->name}}-{{$value->branch}}" class="btn btn-primary btn-border">{{$value->name}} - {{$value->branch}}</a>
                        @endforeach
                    </p>
                </div>
            </div>
...
<div class="page-inner">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="{{url('/admin/search-menu-price')}}" enctype="multipart/form-data" method="post">@csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>       
                                            ...
                                            <a href="{{url('/admin/menu-price-detail')}}/{{$value->id}}">
                                    ...
                                    <div class="modal fade" id="EditPrice{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{url('/admin/update-menu-price')}}" enctype="multipart/form-data" method="post">@csrf
