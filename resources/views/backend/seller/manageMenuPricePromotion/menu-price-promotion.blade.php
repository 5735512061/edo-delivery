...
<div class="page-inner">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="{{url('/seller/search-menu-price-promotion')}}" enctype="multipart/form-data" method="post">@csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                @endphp
                                    <tr>
                                        ...
                                        <td>       
                                            ...
                                            <a href="{{url('/seller/menu-price-promotion-detail')}}/{{$value->id}}">
                                    ...
                                    <div class="modal fade" id="EditPrice{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="Title" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{url('/seller/update-menu-price-promotion')}}" enctype="multipart/form-data" method="post">@csrf
