...
@section("content")
<center><h1>สมัครงานในเครือ Edo Group</h1></center>
            ...
            <div class="row">
              <div class="col-md-3"><br>
                @if ($errors->has('position'))
                  <span class="text-danger" style="font-size: 15px;">({{ $errors->first('position') }})</span><br>
                @endif
            ...
            <legend class="scheduler-border">ประวัติการทำงาน</legend>
              <div class="row">
                <div class="col-md-12">
                  ...
                  @endif
                  <textarea name="history_work" rows="4" class="form-control" style="border-radius: 4px; margin:8px 0; font-family:'Mitr' !important;"  placeholder="ตัวอย่าง : 1. พนักงานเสิร์ฟ ร้านอาหาร ระยะเวลา 2 ปี" value="{{ old('history_work') }}"></textarea>
                </div>
              </div>
          </fieldset>
          {{-- แนบไฟล์เอกสาร --}}
